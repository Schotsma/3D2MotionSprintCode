...
void setup() {
  pinMode(buttonPin, INPUT_PULLUP);//I referenced this code from a previous project that I did
...
for(pos = 0; pos < 180; pos += 10) // if the position is less than 180, add more and itgoes from 0 degrees to 180 degrees
...
for(pos = 180; pos>=1; pos-=10) // if the position is greater than or equal to 1 then subtract until its not
